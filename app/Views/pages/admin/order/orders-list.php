                         ...
                         <div class="card-header border-0">
                              <div class="row justify-content-between align-items-center">
                                   <div class="col-lg-12">
                                        ...
                                        <input type="text" class="btn btn-outline-secondary mr-3" placeholder="search by payment status">
                                        <input type="text" class="btn btn-outline-secondary" placeholder="search by order status">
                                   </div>
                              </div>
                         </div>
                    </div>
                                        ...
                                        <tr>
                                             ...
                                             <td>
                                                  <div class="d-flex gap-2">
                                                       <a href="<?= base_url('admin/detail-order') ?>" class="btn btn-light btn-sm"><iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon></a>
                                                       <a href="<?= base_url('admin/edit-order') ?>" class="btn btn-soft-primary btn-sm"><iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon></a>
