     ...
     <div class="row">
                                             ...
                                             <tbody>
                                                       ...
                                                       <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                 <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                      <img src="<?= base_url('assets/images/product/p-1.png') ?>" alt="" class="avatar-md">
                                                                 </div>
                                                                 <div>
                                                  ...
                                                  <tr>
                                                       <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                 <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                      <img src="<?= base_url('assets/images/product/p-2.png') ?>" alt="" class="avatar-md">
                                                                 </div>
                                                                 <div>
                                                  ...
                                                  <tr>
                                                       <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                 <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                      <img src="<?= base_url('assets/images/product/p-8.png') ?>" alt="" class="avatar-md">
                                                                 </div>
                                                                 <div>
                                                  ...
                                                  <tr>
                                                       <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                 <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                      <img src="<?= base_url('assets/images/product/p-10.png') ?>" alt="" class="avatar-md">
                                                                 </div>
                                                                 <div>
          ...
          <div class="col-xl-3 col-lg-4">
               ...
               <div class="card">
                    ...
                    <div class="card-body">
                         <div class="d-flex align-items-center gap-2">
                              <img src="<?= base_url('assets/images/users/avatar-1.jpg') ?>" alt="" class="avatar rounded-3 border border-light border-3">
                              <div>
