          ...
          <div class="col-xl-12">
               <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                         <h4 class="card-title flex-grow-1">All Warehouse List</h4>
                    </div>
                    <!-- Filters -->
                              ...
                              <div class="row justify-content-between align-items-center">
                                   ...
                                   <div class="col-lg-2">
                                        <div class="text-md-end mt-3 mt-md-0">
                                             <a href="<?= base_url('admin/inventory-received-order') ?>" class="btn btn-success me-1"><i class="bx bx-plus"></i> Received Orders</a>
                                        </div>
                                   </div>
                              </div>
                         </div>
