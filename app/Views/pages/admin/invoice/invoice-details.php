                    ...
                    <div class="card-body">
                         <div class="clearfix pb-3 bg-info-subtle p-lg-3 p-2 m-n2 rounded position-relative">
                              <div class="float-sm-start">
                                   <div class="auth-logo">
                                        <img class="logo-dark me-1" src="<?= base_url('assets/images/logo-dark.png') ?>" alt="logo-dark" height="24" />
                                   </div>
                                   <div class="mt-4">
                                        <h4>Larkon Admin.</h4>
                              ...
                              <div class="position-absolute top-100 start-50 translate-middle">
                                   <img src="<?= base_url('assets/images/check-2.png') ?>" alt="" class="img-fluid">
                              </div>
                         </div>
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr>
                                                       <td>
                                                            <div class="d-flex align-items-center gap-3">
                                                                 <div class="rounded bg-light avatar d-flex align-items-center justify-content-center">
                                                                      <img src="<?= base_url('assets/images/product/p-10.png') ?>" alt="" class="avatar">
                                                                 </div>
                                                                 <div>
