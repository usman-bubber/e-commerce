               ...
               <div class="card overflow-hidden">
                    <div class="card-body">
                         <div class="bg-primary profile-bg rounded-top position-relative mx-n3 mt-n3">
                              <img src="<?= base_url('assets/images/users/avatar-1.jpg') ?>" alt="" class="avatar-xl border border-light border-3 rounded-circle position-absolute top-100 start-0 translate-middle ms-5">
                         </div>
          ...
          <div class="col-xl-4 col-lg-5">
               ...
               <div class="card overflow-hidden z-1">
                    <div class="card-body text-center">
                         ...
                         <img src="<?= base_url('assets/images/qr-code.png') ?>" alt="" class="avatar-xl">
     ...
     <div class="row">
          ...
          <div class="col-lg-9">
               <div class="card">
                    <div class="card-body">
                         <div class="d-flex align-items-center gap-2">
                              <img src="<?= base_url('assets/images/users/avatar-1.jpg') ?>" alt="" class="avatar-md rounded-circle border border-light border-3">
                              <div>
               ...
               <div class="card">
                    <div class="card-body">
                         <div class="d-flex align-items-center gap-2">
                              <img src="<?= base_url('assets/images/users/avatar-2.jpg') ?>" alt="" class="avatar-md rounded-circle border border-light border-3">
                              <div>
