          ...
          <div class="col-xxl-3">
               <div class="offcanvas-xxl offcanvas-start h-100" tabindex="-1" id="Contactoffcanvas" aria-labelledby="ContactoffcanvasLabel">
                    <div class="card position-relative overflow-hidden">
                         ...
                         <!-- All active Users Profile -->
                         <div class="swiper mySwiper p-1 mx-3">
                              <div class="swiper-wrapper">
                                   <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                             <span><img src="<?= base_url('assets/images/users/avatar-1.jpg') ?>" alt="avatar-1" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                        </div>
                                   </div>
                                   <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                             <span><img src="<?= base_url('assets/images/users/avatar-2.jpg') ?>" alt="avatar-2" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                        </div>
                                   </div>
                                   <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                             <span><img src="<?= base_url('assets/images/users/avatar-3.jpg') ?>" alt="avatar-3" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                        </div>
                                   </div>
                                   <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                             <span><img src="<?= base_url('assets/images/users/avatar-4.jpg') ?>" alt="avatar-4" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                        </div>
                                   </div>
                                   <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                             <span><img src="<?= base_url('assets/images/users/avatar-5.jpg') ?>" alt="avatar-5" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="tab-content">
                              ...
                              <div class="tab-pane show active" id="chat-list">
                                   <div class="px-3 mb-3 chat-setting-height" data-simplebar>
                                        <a href="javascript:void(0);" class="text-body">
                                             <div class="d-flex align-items-center p-2">
                                                  <div class="flex-shrink-0 position-relative">
                                                       <img src="<?= base_url('assets/images/users/avatar-2.jpg') ?>" class="me-2 rounded-circle" height="36" alt="avatar-2" />
                                                  </div>
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                             <div class="d-flex align-items-center p-2">
                                                  <div class="flex-shrink-0 position-relative">
                                                       <img src="<?= base_url('assets/images/users/avatar-3.jpg') ?>" class="me-2 rounded-circle" height="36" alt="avatar-3" />
                                                  </div>
                                                  <div class="flex-grow-1 overflow-hidden">
                                                       <h6 class="my-0">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                             <div class="d-flex align-items-center bg-light bg-opacity-50 p-2 rounded-1">
                                                  <div class="flex-shrink-0 position-relative">
                                                       <img src="<?= base_url('assets/images/users/avatar-4.jpg') ?>" class="me-2 rounded-circle" height="36" alt="avatar-4" />
                                                  </div>
                                                  <div class="flex-grow-1 overflow-hidden">
                                                       <h6 class="my-0">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                             <div class="d-flex align-items-center p-2">
                                                  <div class="flex-shrink-0 position-relative">
                                                       <img src="<?= base_url('assets/images/users/avatar-5.jpg') ?>" class="me-2 rounded-circle" height="36" alt="avatar-5" />
                                                  </div>
                                                  <div class="flex-grow-1 overflow-hidden">
                                                       <h6 class="my-0">
                              ...
                              <div class="tab-pane" id="contact-list">
                                   <div class="px-3 mb-3 chat-setting-height" data-simplebar>
                                        ...
                                        <div class="d-flex align-items-center position-relative py-2">
                                             <a href="#!" class="stretched-link"><img src="<?= base_url('assets/images/users/avatar-2.jpg') ?>" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                             <div class="flex-grow-1">
                                                  <h6 class="my-0 fs-14">Muhammad Usman</h6>
                                             </div>
                                        </div>
                                        <div class="d-flex align-items-center position-relative py-2">
                                             <a href="#!" class="stretched-link"><img src="<?= base_url('assets/images/users/avatar-2.jpg') ?>" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
               ...
               <div class="card position-relative overflow-hidden">
                    <div class="card-header d-flex align-items-center mh-100">
                         ...
                         <div class="d-flex align-items-center">
                              <img src="<?= base_url('assets/images/users/avatar-4.jpg') ?>" class="me-2 rounded" height="36" alt="avatar-4" />
                                        ...
                                        <div class="d-flex">
                                             <div class="chat-ctext-wrap">
                                                  <a href="javascript:void(0);">
                                                       <img src="<?= base_url('assets/images/small/img-1.jpg') ?>" alt="attachment" style="height: 84px;" class="img-thumbnail me-1">
                                                  </a>
                                                  <a href="javascript:void(0);">
                                                       <img src="<?= base_url('assets/images/small/img-2.jpg') ?>" alt="attachment" style="height: 84px;" class="img-thumbnail me-1">
                                                  </a>
                                                  <a href="javascript:void(0);">
                                                       <img src="<?= base_url('assets/images/small/img-3.jpg') ?>" alt="attachment" style="height: 84px;" class="img-thumbnail me-1">
                                                  </a>
                                             </div>
                                             <div class="chat-conversation-actions dropdown dropend">
                                                  <a href="javascript: void(0);" class="ps-1" data-bs-toggle="dropdown" aria-expanded="false"><i class='bx bx-dots-vertical-rounded fs-18'></i></a>
