                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <h6 class="mb-1">Quantity:
                                    <?= $quantity ?>
                                </h6>
                            </div>
                            <div class="col-md-4 text-end">
                                <p class="mb-1">Item Price: <span class="fw-bold"><?= number_format($product['price']) ?> PKR</span></p>
                                ...
                                <p class="mb-1">Total Price: <span class="fw-bold"><?= number_format($itemTotalPrice) ?> PKR</span></p>
