            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6>Best new Joker</h6>
                        <a href="<?= base_url('shop-detail') ?>" class="add-cart">+ Add To Cart</a>
                        <div class="rating">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="categories__hot__deal">
                    <img src="<?= base_url('assets/img/product-sale.png') ?>" alt="">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="instagram__pic">
                    <div class="instagram__pic__item set-bg" data-setbg="<?= base_url('assets/img/instagram/instagram-1.jpg') ?>"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="<?= base_url('assets/img/instagram/instagram-2.jpg') ?>"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="<?= base_url('assets/img/instagram/instagram-3.jpg') ?>"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="<?= base_url('assets/img/instagram/instagram-4.jpg') ?>"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="<?= base_url('assets/img/instagram/instagram-5.jpg') ?>"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="<?= base_url('assets/img/instagram/instagram-6.jpg') ?>"></div>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="<?= base_url('assets/img/blog/blog-1.jpg') ?>"></div>
                    <div class="blog__item__text">
                        <span><img src="<?= base_url('assets/img/icon/calendar.png') ?>" alt=""> 16 February 2020</span>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="<?= base_url('assets/img/blog/blog-2.jpg') ?>"></div>
                    <div class="blog__item__text">
                        <span><img src="<?= base_url('assets/img/icon/calendar.png') ?>" alt=""> 21 February 2020</span>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="<?= base_url('assets/img/blog/blog-3.jpg') ?>"></div>
                    <div class="blog__item__text">
                        <span><img src="<?= base_url('assets/img/icon/calendar.png') ?>" alt=""> 28 February 2020</span>
