                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="payment_id" value="1" id="cashOnDelivery" checked>
                            <label class="form-check-label" for="cashOnDelivery">Cash on Delivery</label>
                        </div>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="radio" name="payment_id" value="2" id="bankTransfer">
                            <label class="form-check-label" for="bankTransfer">Bank Transfer</label>
                        </div>
                        <!-- <div class="form-check">
                            <input class="form-check-input" type="radio" name="payment_id" id="creditCard">
                        ...
                        <div class="reviews-section">
                            ...
                            ?>
                                    <div class="review-card d-flex mb-3 gap-4">
                                        ...
                                        <div class="ms-3">
                                            <p class="small fw-bold"><?= esc($productdetail['price']) ?>PKR</p>
                                        </div>
                                    </div>
                            <?php
                                }
